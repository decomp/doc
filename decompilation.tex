...
\begin{figure}[htbp]
	\lstinputlisting[language=nasm,style=nasm,xleftmargin=1cm,xrightmargin=1cm]{inc/elf_text.asm}
	\caption{The assembly instructions of the \texttt{.text} section.}
	\label{elf_text}
\end{figure}

\begin{figure}[htbp]
	\lstinputlisting[language=nasm,style=nasm,xleftmargin=1cm,xrightmargin=1cm]{inc/elf_plt.asm}
