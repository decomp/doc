...
The binary analysis phase is responsible for parsing the various binary file formats, such as PE and ELF, and present its content in a uniform manner which preserves the relation between file content, virtual address and access permissions.
