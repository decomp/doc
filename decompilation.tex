...
Thanks to the simplicity of REIL a full definition of its instruction set has been provided in appendix \ref{reil_appendix}, which includes examples of each instruction and defines their syntax and semantics (in pseudo C-code).
...
\end{document} % TODO: Remove to include appendices.
...
\includepdf[pages=-]{appendices/PID_orig.pdf} % TODO: Replace with PID.pdf (signed version).
...
\lstinputlisting[language=reil,style=nasm,caption={A full definition of the REIL instruction set. \label{reil_instruction_set}}]{inc/reil_instruction_set.asm}
