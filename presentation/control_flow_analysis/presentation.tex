...
%   - functional equivalence, with a lot of goto-s to begin.
%   - clean up over time.
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[ht]{0.40\textwidth}
			...
			\caption{Intervals outlined in control flow graph\footnotemark.}
		\end{subfigure}
	\end{figure}

	\footnotetext{Figure adapted from \fullcite{cifuentes_reverse_comp} \\}
...
% TODO: add slide with short-circuit compound conditions?
...
\begin{frame}
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linerange={17-43}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/example/sample.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
\begin{frame}[noframenumbering]
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linerange={17-43}, linebackgroundcolor={\btLstHL{22}}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/example/sample.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
\begin{frame}[noframenumbering]
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linerange={17-43}, linebackgroundcolor={\btLstHL{15-18}}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/example/sample.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
\begin{frame}[noframenumbering]
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linerange={17-43}, linebackgroundcolor={\btLstHL{12-13,19-20}}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/example/sample.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
\begin{frame}[noframenumbering]
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linerange={17-43}, linebackgroundcolor={\btLstHL{22-24}}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/example/sample.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
\begin{frame}[noframenumbering]
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linerange={17-43}, linebackgroundcolor={\btLstHL{3,10}}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/example/sample.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
% Jump threading optimization and boolean constraint propagation.
...
\begin{frame}
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linerange={8-21}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/counter-example/bool_propagation.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
\begin{frame}[noframenumbering]
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linebackgroundcolor={\btLstHL{4-6}}, linerange={8-21}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/counter-example/bool_propagation.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
\begin{frame}[noframenumbering]
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.30\textwidth}
			\centering
			\lstinputlisting[linebackgroundcolor={\btLstHL{4,12}}, linerange={8-21}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/interval/counter-example/bool_propagation.c}
			\caption{Original C source code.}
		\end{subfigure}
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
...
\begin{frame}
	...
	\begin{figure}[htbp]
		...
		\begin{subfigure}[b]{0.40\textwidth}
			\centering
			\includegraphics[height=0.7\paperheight]{inc/methods/pattern-independent/sess-regions.png}
			\label{fig:pattern_independent}
			\caption{Single-entry single-successor regions\footnotemark.}
		\end{subfigure}
		\qquad
		\begin{subfigure}[b]{0.50\textwidth}
			\centering
			\lstinputlisting[linerange={5-30}, caption={\label{lst:pattern_independent} Recovered control flow primitives.}, language=C, style=c, basicstyle=\tiny\ttfamily, breaklines=false]{inc/methods/pattern-independent/sample.c}
			%\caption{Single-entry single-successor regions}
		\end{subfigure}
	\end{figure}

	\footnotetext{Figure and listing adapted from \fullcite{no_more_gotos} \\}
