...
\lstinputlisting[language=go, style=go, caption={The structured CFG (in JSON format) produced by the \texttt{restructure} tool when analysing the CFG of the \texttt{main} function presented in figure~\ref{fig:example1_unstructured_cfg}. \label{lst:example1_structured_cfg}}]{inc/appendices/restructure_example/example1_graphs/main.json}
