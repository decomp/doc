...
\lstinputlisting[language=llvm, style=nasm, caption={An optimized version of the LLVM IR assembly, which was emitted by Clang when compiling the C source code of listing \ref{lst:example1_c}. \label{lst:example1_ll}}]{inc/appendices/clang_example/example1.ll}
