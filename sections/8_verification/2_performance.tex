...
\begin{table}[htbp]
	\begin{center}
		\begin{tabular}{|l|l|l|l|l|l|l|}
			...
			% * unresolved
			%
			%  0.09s (0m00.087s, 0m00.085s, 0m00.084s)
			%  0.29s (0m00.306s, 0m00.286s, 0m00.280s)
			%  1.01s (0m01.008s, 0m01.022s, 0m01.007s)
			%  3.70s (0m03.728s, 0m03.669s, 0m03.703s)
			% 13.87s (0m13.915s, 0m13.771s, 0m13.920s)
			% 53.35s (0m53.265s, 0m53.484s, 0m53.305s)
			%
			% As the size of n doubles, the execution time roughly quadruples (4).
			\rowcolor{light_green_3}
			...
			% * mainret
			%
			%  0.09s (0m00.084s, 0m00.084s, 0m00.086s)
			%  0.28s (0m00.270s, 0m00.279s, 0m00.276s)
			%  1.00s (0m01.000s, 0m00.997s, 0m01.011s)
			%  3.70s (0m03.658s, 0m03.764s, 0m03.678s)
			% 13.91s (0m13.891s, 0m13.926s, 0m13.900s)
			% 52.91s (0m53.045s, 0m53.029s, 0m52.655s)
			%
			% As the size of n doubles, the execution time roughly quadruples (4).
			\rowcolor{light_green_3}
			...
			% * assignbinop
			%
			% 0.02s (0m0.015s, 0m0.013s, 0m0.014s)
			% 0.03s (0m0.029s, 0m0.029s, 0m0.028s)
			% 0.07s (0m0.074s, 0m0.073s, 0m0.072s)
			% 0.21s (0m0.213s, 0m0.215s, 0m0.215s)
			% 0.72s (0m0.720s, 0m0.720s, 0m0.719s)
			% 2.63s (0m2.652s, 0m2.613s, 0m2.619s)
			%
			% As the size of n doubles, the execution time roughly quadruples (4).
			\rowcolor{light_green_3}
			...
			% * deadassign
			%
			%  0.08s (0m00.078s, 0m00.081s, 0m00.082s)
			%  0.26s (0m00.251s, 0m00.266s, 0m00.263s)
			%  0.95s (0m00.903s, 0m00.999s, 0m00.946s)
			%  3.40s (0m03.372s, 0m03.402s, 0m03.422s)
			% 13.00s (0m12.847s, 0m13.085s, 0m13.078s)
			% 49.96s (0m49.448s, 0m50.316s, 0m50.128s)
			%
			% As the size of n doubles, the execution time roughly quadruples (4).
			\rowcolor{light_green_3}
			...
			% * forloop
			%
			% 0.01s (0m0.012s, 0m0.012s, 0m0.013s)
			% 0.03s (0m0.038s, 0m0.024s, 0m0.035s)
			% 0.06s (0m0.057s, 0m0.055s, 0m0.054s)
			% 0.15s (0m0.150s, 0m0.149s, 0m0.147s)
			% 0.45s (0m0.455s, 0m0.457s, 0m0.451s)
			% 1.63s (0m1.631s, 0m1.633s, 0m1.640s)
			%
			% As the size of n doubles, the execution time roughly quadruples (4).
			%
			% NOTE: Re-run the test with 2^x nested for-loops.
			\rowcolor{light_green_3}
