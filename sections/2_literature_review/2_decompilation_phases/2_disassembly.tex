...
One problem faced by both linear descent and recursive descent disassemblers is the need for a starting point. Identifying exported entry point symbols (e.g. \texttt{main}, \texttt{start}, \texttt{DllMain}, …) for this purpose works well in practice.
