...
% quality systems from start - evolutionary protptypes - which evolve over time.

% Built in a quality manner; including test-cases, documentation, API design.
% * Implement only understood requirements (why implement a poorly understood requirement, when you would understand them much better after building the first prototype?)

% \textit{``Throwaway and evolutionary prototyping have almost nothing in common except the word prototyping''}

% Works well when most of the critical functions are well understood.
