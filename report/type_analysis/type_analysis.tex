...
For these reasons, conducting formal verification and semantic analysis on the output rather than the input of a compiler is important.

 the output of a compiler has to be verified to ensure that  even formally verified input source code to a compiler may produce faulty output binaries if the compiler has been tampered with \cite{}.
