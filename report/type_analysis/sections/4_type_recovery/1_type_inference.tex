...
\todo{TODO: reference g and h example.}

%This is common when using \texttt{memcpy} and \texttt{memmove} on structure types.

% (e.g. the size of fields for a structure type)
