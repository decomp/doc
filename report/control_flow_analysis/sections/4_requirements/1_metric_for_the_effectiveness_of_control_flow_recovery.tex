...
\todo{TODO: take ideas from and include reference to \cite{no_more_gotos} as a notion of effective control} \\
\todo{flow recovery is clearly defined there, in section VII.A. Metrics;} \\
\todo{including the notion of \textbf{Correctness}, \textbf{Structuredness} and \textbf{Compactness}}.
