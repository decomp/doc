	...
	\begin{center}
		\resizebox{\textwidth}{!}{
			\begin{tabular}{|l|l|l|l|}
				...
				\hline
				\ref{itm:obj_define_effectiveness_metric} & \textbf{R10} & WON'T & Consider \textit{goto} statements \\
				\ref{itm:obj_define_effectiveness_metric} & \textbf{R11} & WON'T & Distinguish between \textit{for}- and \textit{while}-loops \\
				\ref{itm:obj_define_effectiveness_metric} & \textbf{R12} & WON'T & Handle irreducible graphs \\
				\hline
			\end{tabular}
		}
	\end{center}
