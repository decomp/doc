	...
	\begin{center}
		\resizebox{\textwidth}{!}{
			\begin{tabular}{|l|l|l|l|}
				...
				\hline
				N/A & \textbf{R10} & WON'T & Consider \textit{goto} statements \\
				N/A & \textbf{R11} & WON'T & Distinguish between \textit{for}- and \textit{while}-loops \\
				N/A & \textbf{R12} & WON'T & Handle irreducible graphs \\
				\hline
			\end{tabular}
		}
	\end{center}
