...
% TODO: 	90% of the false positives have this property. <<< valuable
...
\todo{TODO: continue here. Summarize the findings briefly discussed} \\
...
%			goto LABEL_51
%		}
%		drlg_l1_generate_hall(18, 12, 18, 14)
%	}
%	if l1_vert_room_2 && l1_vert_room_3 {
%		drlg_l1_generate_hall(18, 26, 18, 28)
%	}
%LABEL_51:
%
%Since the first !l1_vert_room_2 is enough to ensure that the condition of the
%second if-statement is never true, a jump has been inserted by the compiler to
%skip the second condition check.
